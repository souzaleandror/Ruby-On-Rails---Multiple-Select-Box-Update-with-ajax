...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { acronym: @state.acronym, active: @state.active, capital: @state.capital, name: @state.name, obs: @state.obs }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { acronym: @state.acronym, active: @state.active, capital: @state.capital, name: @state.name, obs: @state.obs }
    assert_redirected_to state_path(assigns(:state))
  end
